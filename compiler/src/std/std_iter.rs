...
pub fn register(reg: &mut NativeRegistry) {
    reg.register("aura.lang.std.Iter.sum", nat_sum);
    reg.register("aura.lang.std.Iter.avg", nat_avg);
    reg.register("aura.lang.std.Iter.min", nat_min);
    reg.register("aura.lang.std.Iter.max", nat_max);
    reg.register("aura.lang.std.Iter.product", nat_product);
    reg.register("aura.lang.std.Iter.contains", nat_contains);
    reg.register("aura.lang.std.Iter.indexOf", nat_index_of);
    reg.register("aura.lang.std.Iter.count", nat_count);
    reg.register("aura.lang.std.Iter.every", nat_every);
    reg.register("aura.lang.std.Iter.some", nat_some);
    reg.register("aura.lang.std.Iter.flatMap", nat_flat_map);
    reg.register("aura.lang.std.Iter.zip", nat_zip);
    reg.register("aura.lang.std.Iter.unzip", nat_unzip);
    reg.register("aura.lang.std.Iter.enumerate", nat_enumerate);
    reg.register("aura.lang.std.Iter.chain", nat_chain);
    reg.register("aura.lang.std.Iter.take", nat_take);
    reg.register("aura.lang.std.Iter.skip", nat_skip);
    reg.register("aura.lang.std.Iter.dropWhile", nat_drop_while);
    reg.register("aura.lang.std.Iter.takeWhile", nat_take_while);
    reg.register("aura.lang.std.Iter.distinct", nat_distinct);
    reg.register("aura.lang.std.Iter.groupBy", nat_group_by);
    reg.register("aura.lang.std.Iter.partition", nat_partition);
    reg.register("aura.lang.std.Iter.fold", nat_fold);
    reg.register("aura.lang.std.Iter.scan", nat_scan);
    reg.register("aura.lang.std.Iter.toMap", nat_to_map);
    reg.register("aura.lang.std.Iter.toList", nat_to_list);
    reg.register("aura.lang.std.Iter.range", nat_range);
    reg.register("aura.lang.std.Iter.rangeTo", nat_range_to);
    reg.register("aura.lang.std.Iter.rangeUntil", nat_range_until);
    reg.register("aura.lang.std.Iter.repeatN", nat_repeat_n);
}
