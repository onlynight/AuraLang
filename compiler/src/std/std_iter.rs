...
pub fn register(reg: &mut NativeRegistry) {
    reg.register("aura.iter.sum", nat_sum);
    reg.register("aura.iter.avg", nat_avg);
    reg.register("aura.iter.min", nat_min);
    reg.register("aura.iter.max", nat_max);
    reg.register("aura.iter.product", nat_product);
    reg.register("aura.iter.contains", nat_contains);
    reg.register("aura.iter.indexOf", nat_index_of);
    reg.register("aura.iter.count", nat_count);
    reg.register("aura.iter.every", nat_every);
    reg.register("aura.iter.some", nat_some);
    reg.register("aura.iter.flatMap", nat_flat_map);
    reg.register("aura.iter.zip", nat_zip);
    reg.register("aura.iter.unzip", nat_unzip);
    reg.register("aura.iter.enumerate", nat_enumerate);
    reg.register("aura.iter.chain", nat_chain);
    reg.register("aura.iter.take", nat_take);
    reg.register("aura.iter.skip", nat_skip);
    reg.register("aura.iter.dropWhile", nat_drop_while);
    reg.register("aura.iter.takeWhile", nat_take_while);
    reg.register("aura.iter.distinct", nat_distinct);
    reg.register("aura.iter.groupBy", nat_group_by);
    reg.register("aura.iter.partition", nat_partition);
    reg.register("aura.iter.fold", nat_fold);
    reg.register("aura.iter.scan", nat_scan);
    reg.register("aura.iter.toMap", nat_to_map);
    reg.register("aura.iter.toList", nat_to_list);
    reg.register("aura.iter.range", nat_range);
    reg.register("aura.iter.rangeTo", nat_range_to);
    reg.register("aura.iter.rangeUntil", nat_range_until);
    reg.register("aura.iter.repeatN", nat_repeat_n);
}
