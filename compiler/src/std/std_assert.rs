...
pub fn register(reg: &mut NativeRegistry) {
    ...
    reg.register("aura.lang.std.Assert.assertEq", nat_assert_eq);
    reg.register("aura.lang.std.Assert.assertNotEq", nat_assert_not_eq);
    reg.register("aura.lang.std.Assert.assertNotNull", nat_assert_not_null);
    reg.register("aura.lang.std.Assert.assertNull", nat_assert_null);
    reg.register("aura.lang.std.Assert.debugAssert", nat_debug_assert);
}
