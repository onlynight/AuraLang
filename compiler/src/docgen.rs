...
impl DocRegistry {
    ...
    pub fn load_all(mut self) -> Self {
        ...
        self.docs.push(StdDoc {
            module: "io",
            name: "aura.lang.std.IO.println",
            summary: "打印一行文本到标准输出，末尾自动追加换行符。",
            params: &[("msg", "String", "要输出的文本（可多参数拼接）")],
            returns: "Unit",
            returns_desc: "无返回值",
            example: Some(r#"aura.lang.std.IO.println("Hello, Aura!")"#),
            rust_fn: "std_io::nat_println",
        });
        self.docs.push(StdDoc {
            module: "io",
            name: "aura.lang.std.IO.print",
            summary: "打印文本到标准输出，不追加换行符。",
            params: &[("msg", "String", "要输出的文本")],
            returns: "Unit",
            returns_desc: "无返回值",
            example: Some(r#"aura.lang.std.IO.print("Hello ") // 不换行"#),
            rust_fn: "std_io::nat_print",
        });
        self.docs.push(StdDoc {
            module: "io",
            name: "aura.lang.std.IO.readLine",
            summary: "从标准输入读取一行文本。",
            params: &[],
            returns: "String",
        ...
        self.docs.push(StdDoc {
            module: "io",
            name: "aura.lang.std.IO.fileRead",
        ...
        self.docs.push(StdDoc {
            module: "io",
            name: "aura.lang.std.IO.fileWrite",
            ...
            example: Some(r#"aura.lang.std.IO.fileWrite("out.txt", "Hello")"#),
            rust_fn: "std_io::nat_file_write",
        });
        self.docs.push(StdDoc {
            module: "io",
            name: "aura.lang.std.IO.fileExists",
            summary: "检查文件或目录是否存在。",
        ...
        self.docs.push(StdDoc {
            module: "math",
            name: "aura.lang.std.Math.abs",
            summary: "返回数值的绝对值。",
            params: &[("x", "Int / Float", "输入值")],
            returns: "Int / Float",
            returns_desc: "绝对值",
            example: Some(r#"aura.lang.std.Math.abs(-42) // → 42"#),
            rust_fn: "std_math::nat_abs",
        });
        self.docs.push(StdDoc {
            module: "math",
            name: "aura.lang.std.Math.min",
            summary: "返回两个整数中的较小值。",
            params: &[
                ("a", "Int", "第一个数"),
                ("b", "Int", "第二个数"),
            ...
            returns: "Int",
            returns_desc: "最小值",
            example: Some(r#"aura.lang.std.Math.min(3, 5) // → 3"#),
            rust_fn: "std_math::nat_min",
        });
        self.docs.push(StdDoc {
            module: "math",
            name: "aura.lang.std.Math.max",
            summary: "返回两个整数中的较大值。",
            params: &[
                ("a", "Int", "第一个数"),
                ("b", "Int", "第二个数"),
            ...
            returns: "Int",
            returns_desc: "最大值",
            example: Some(r#"aura.lang.std.Math.max(3, 5) // → 5"#),
            rust_fn: "std_math::nat_max",
        });
        self.docs.push(StdDoc {
            module: "math",
            name: "aura.lang.std.Math.sqrt",
            summary: "返回数的平方根。",
            params: &[("x", "Float", "输入值（≥0）")],
            returns: "Float",
            returns_desc: "平方根",
            example: Some(r#"aura.lang.std.Math.sqrt(16.0) // → 4.0"#),
            rust_fn: "std_math::nat_sqrt",
        });
        self.docs.push(StdDoc {
            module: "math",
            name: "aura.lang.std.Math.pow",
            ...
            returns: "Float",
            returns_desc: "幂运算结果",
            example: Some(r#"aura.lang.std.Math.pow(2.0, 10.0) // → 1024.0"#),
            rust_fn: "std_math::nat_pow",
        });
        self.docs.push(StdDoc {
            module: "math",
            name: "aura.lang.std.Math.PI",
        ...
        self.docs.push(StdDoc {
            module: "math",
            name: "aura.lang.std.Math.ceil",
            summary: "向上取整。",
            params: &[("x", "Float", "输入值")],
            returns: "Float",
            returns_desc: "≥ x 的最小整数",
            example: Some(r#"aura.lang.std.Math.ceil(1.2) // → 2.0"#),
            rust_fn: "std_math::nat_ceil",
        });
        self.docs.push(StdDoc {
            module: "math",
            name: "aura.lang.std.Math.floor",
            summary: "向下取整。",
            params: &[("x", "Float", "输入值")],
            returns: "Float",
            returns_desc: "≤ x 的最大整数",
            example: Some(r#"aura.lang.std.Math.floor(1.8) // → 1.0"#),
        ...
        self.docs.push(StdDoc {
            module: "string",
            name: "aura.lang.std.String.contains",
            summary: "判断字符串是否包含子串。",
            params: &[
                ("text", "String", "源字符串"),
                ("substr", "String", "子串"),
            ...
            example: Some(r#"aura.lang.std.String.contains("hello", "ell") // → true"#),
            rust_fn: "std_string::nat_contains",
        });
        self.docs.push(StdDoc {
            module: "string",
            name: "aura.lang.std.String.startsWith",
        ...
        self.docs.push(StdDoc {
            module: "string",
            name: "aura.lang.std.String.endsWith",
        ...
        self.docs.push(StdDoc {
            module: "string",
            name: "aura.lang.std.String.split",
            ...
            example: Some(r#"aura.lang.std.String.split("a,b,c", ",") // → ["a", "b", "c"]"#),
            rust_fn: "std_string::nat_split",
        });
        self.docs.push(StdDoc {
            module: "string",
            name: "aura.lang.std.String.join",
        ...
        self.docs.push(StdDoc {
            module: "string",
            name: "aura.lang.std.String.replace",
            summary: "替换第一个匹配的子串。",
            params: &[
                ("text", "String", "源字符串"),
            ...
            example: Some(r#"aura.lang.std.String.replace("hello world", "world", "Aura")"#),
            rust_fn: "std_string::nat_replace",
        });
        self.docs.push(StdDoc {
            module: "string",
            name: "aura.lang.std.String.toUpperCase",
            summary: "将所有字母转换为大写。",
            params: &[("text", "String", "源字符串")],
            returns: "String",
            returns_desc: "大写字符串",
            example: Some(r#"aura.lang.std.String.toUpperCase("hello") // → "HELLO""#),
            rust_fn: "std_string::nat_to_upper",
        });
        self.docs.push(StdDoc {
            module: "string",
            name: "aura.lang.std.String.toLowerCase",
            summary: "将所有字母转换为小写。",
            params: &[("text", "String", "源字符串")],
            returns: "String",
            returns_desc: "小写字符串",
            example: Some(r#"aura.lang.std.String.toLowerCase("HELLO") // → "hello""#),
            rust_fn: "std_string::nat_to_lower",
        });
        self.docs.push(StdDoc {
            module: "string",
            name: "aura.lang.std.String.length",
            summary: "返回字符串的字符数。",
            params: &[("text", "String", "源字符串")],
            returns: "Int",
            returns_desc: "字符数量",
        ...
        self.docs.push(StdDoc {
            module: "string",
            name: "aura.lang.std.String.trim",
            summary: "去除首尾空白字符。",
            params: &[("text", "String", "源字符串")],
            returns: "String",
            returns_desc: "修剪后的字符串",
            example: Some(r#"aura.lang.std.String.trim("  hello  ") // → "hello""#),
            rust_fn: "std_string::nat_trim",
        });
        self.docs.push(StdDoc {
            module: "string",
            name: "aura.lang.std.String.format",
            ...
            example: Some(r#"aura.lang.std.String.format("Hello {0}", "Aura") // → "Hello Aura""#),
            rust_fn: "std_string::nat_format",
        });
        self.docs.push(StdDoc {
            module: "string",
            name: "aura.lang.std.String.matches",
            summary: "正则表达式匹配。",
            params: &[
                ("text", "String", "源字符串"),
                ("regex", "String", "正则表达式"),
        ...
        self.docs.push(StdDoc {
            module: "collections",
            name: "aura.lang.std.Collections.listOf",
            summary: "构造不可变列表。",
            params: &[("...", "Value", "任意数量元素")],
            returns: "List",
        ...
        self.docs.push(StdDoc {
            module: "collections",
            name: "aura.lang.std.Collections.mapOf",
        ...
        self.docs.push(StdDoc {
            module: "collections",
            name: "aura.lang.std.Collections.setOf",
            summary: "构造集合（自动去重）。",
            params: &[("...", "Value", "任意数量元素")],
            returns: "List",
        ...
        self.docs.push(StdDoc {
            module: "collections",
            name: "aura.lang.std.Collections.emptyList",
            summary: "构造空列表。",
            params: &[],
            returns: "List",
            returns_desc: "空列表",
        ...
        self.docs.push(StdDoc {
            module: "collections",
            name: "aura.lang.std.Collections.listContains",
        ...
        self.docs.push(StdDoc {
            module: "fs",
            name: "aura.lang.std.FileSystem.exists",
            summary: "检查路径是否存在。",
        ...
        self.docs.push(StdDoc {
            module: "fs",
            name: "aura.lang.std.FileSystem.readText",
            summary: "读取文件文本内容。",
            params: &[("path", "String", "文件路径")],
            returns: "String",
        ...
        self.docs.push(StdDoc {
            module: "fs",
            name: "aura.lang.std.FileSystem.writeText",
            summary: "将文本写入文件。",
            params: &[
                ("path", "String", "文件路径"),
                ("content", "String", "文本内容"),
        ...
        self.docs.push(StdDoc {
            module: "fs",
            name: "aura.lang.std.FileSystem.mkdir",
            summary: "创建目录。",
        ...
        self.docs.push(StdDoc {
            module: "fs",
            name: "aura.lang.std.FileSystem.mkdirP",
        ...
        self.docs.push(StdDoc {
            module: "fs",
            name: "aura.lang.std.FileSystem.listDir",
        ...
        self.docs.push(StdDoc {
            module: "fs",
            name: "aura.lang.std.FileSystem.fileSize",
            summary: "返回文件大小（字节）。",
            params: &[("path", "String", "文件路径")],
            returns: "Int",
        ...
        self.docs.push(StdDoc {
            ...
            example: Some(r#"aura.lang.std.Json.stringify({name: "Aura"})"#),
            rust_fn: "std_json::nat_stringify",
        });
        self.docs.push(StdDoc {
            module: "json",
            name: "aura.lang.std.Json.isValid",
        ...
        self.docs.push(StdDoc {
            module: "time",
            name: "aura.lang.std.Time.sleep",
            summary: "暂停执行指定秒数。",
            params: &[("seconds", "Float", "暂停秒数")],
            returns: "Unit",
            returns_desc: "无返回值",
            example: Some(r#"aura.lang.std.Time.sleep(1.0)"#),
            rust_fn: "std_time::nat_sleep",
        });
        self.docs.push(StdDoc {
            module: "time",
            name: "aura.lang.std.Time.toDateString",
            summary: "将时间戳转换为日期字符串（YYYY-MM-DD）。",
            params: &[("timestamp", "Int", "Unix 时间戳（秒）")],
            returns: "String",
            returns_desc: "格式化日期",
            example: Some(r#"aura.lang.std.Time.toDateString(0) // → "1970-01-01""#),
        ...
        self.docs.push(StdDoc {
            module: "test",
            name: "aura.lang.std.Test.assertTrue",
            ...
            example: Some(r#"aura.lang.std.Test.assertTrue(true, "all good")"#),
            rust_fn: "std_test::nat_assert_true",
        });
        self.docs.push(StdDoc {
            module: "test",
            name: "aura.lang.std.Test.assertEq",
            summary: "断言两个值相等。",
            params: &[
                ("a", "Value", "实际值"),
                ("b", "Value", "期望值"),
            ...
            returns: "String",
            returns_desc: "\"PASS: ...\" 或 \"FAIL: ...\"",
            example: Some(r#"aura.lang.std.Test.assertEq(42, 42, "answer")"#),
        ...
        self.docs.push(StdDoc {
            module: "builtin",
            name: "aura.lang.std.Builtin.typeof",
            summary: "返回值的类型名称。",
            params: &[("value", "Value", "待检查的值")],
            returns: "String",
            returns_desc: "类型名（Int/Float/Boolean/String/List/Map/Null）",
            example: Some(r#"aura.lang.std.Builtin.typeof(42) // → "Int""#),
            rust_fn: "std_builtin::nat_typeof",
        });
        self.docs.push(StdDoc {
            module: "builtin",
            name: "aura.lang.std.Builtin.toString",
            summary: "将任意值转换为字符串。",
        ...
        self.docs.push(StdDoc {
            module: "env",
            name: "aura.lang.std.Env.platform",
            summary: "返回当前操作系统名称。",
            params: &[],
            returns: "String",
        ...
        self.docs.push(StdDoc {
            module: "random",
            name: "aura.lang.std.Random.nextInt",
            summary: "返回 64 位随机整数。",
            params: &[],
            returns: "Int",
        ...
        self.docs.push(StdDoc {
            module: "random",
            name: "aura.lang.std.Random.nextFloat",
        ...
        self.docs.push(StdDoc {
            module: "random",
            name: "aura.lang.std.Random.nextIntRange",
            ...
            example: Some(r#"aura.lang.std.Random.nextIntRange(1, 100)"#),
            rust_fn: "std_random::nat_next_int_range",
        });
        self.docs.push(StdDoc {
            module: "random",
            name: "aura.lang.std.Random.choice",
            summary: "从参数列表中随机选择一个元素。",
            params: &[("...", "Value", "候选元素")],
            returns: "Value",
            returns_desc: "随机选中的元素",
            example: Some(r#"aura.lang.std.Random.choice(1, 2, 3)"#),
            rust_fn: "std_random::nat_choice",
        });
        self.docs.push(StdDoc {
            module: "random",
            name: "aura.lang.std.Random.shuffle",
            summary: "返回列表的随机排列。",
        ...
        self.docs.push(StdDoc {
            module: "encoding",
            name: "aura.lang.std.Encoding.base64Encode",
            summary: "将字符串编码为 Base64。",
            params: &[("text", "String", "源字符串")],
            returns: "String",
            returns_desc: "Base64 编码字符串",
            example: Some(r#"aura.lang.std.Encoding.base64Encode("Hello")"#),
            rust_fn: "std_encoding::nat_base64_encode",
        });
        self.docs.push(StdDoc {
            module: "encoding",
            name: "aura.lang.std.Encoding.base64Decode",
        ...
        self.docs.push(StdDoc {
            module: "encoding",
            name: "aura.lang.std.Encoding.hexEncode",
            summary: "将字符串编码为十六进制。",
            params: &[("text", "String", "源字符串")],
            returns: "String",
            returns_desc: "十六进制字符串",
            example: Some(r#"aura.lang.std.Encoding.hexEncode("Hi") // → "4869""#),
        ...
        self.docs.push(StdDoc {
            module: "ascii",
            name: "aura.lang.std.Ascii.isAlpha",
            summary: "判断首字符是否为字母。",
            params: &[("text", "String", "字符串")],
            returns: "Bool",
            returns_desc: "是字母返回 true",
            example: Some(r#"aura.lang.std.Ascii.isAlpha("A") // → true"#),
            rust_fn: "std_ascii::nat_is_alpha",
        });
        self.docs.push(StdDoc {
            module: "ascii",
            name: "aura.lang.std.Ascii.isDigit",
            summary: "判断首字符是否为数字。",
            params: &[("text", "String", "字符串")],
            returns: "Bool",
        ...
        self.docs.push(StdDoc {
            module: "ascii",
            name: "aura.lang.std.Ascii.codeAt",
            ...
            example: Some(r#"aura.lang.std.Ascii.codeAt("A", 0) // → 65"#),
        ...
        self.docs.push(StdDoc {
            module: "path",
            name: "aura.lang.std.Path.join",
            summary: "拼接多个路径组件。",
            params: &[("...", "String", "路径组件")],
            returns: "String",
            returns_desc: "拼接后的路径",
            example: Some(r#"aura.lang.std.Path.join("dir", "file.txt")"#),
            rust_fn: "std_path::nat_join",
        });
        self.docs.push(StdDoc {
            module: "path",
            name: "aura.lang.std.Path.basename",
            summary: "返回文件名（不含扩展名）。",
            params: &[("path", "String", "文件路径")],
            returns: "String",
            returns_desc: "文件基名",
            example: Some(r#"aura.lang.std.Path.basename("dir/file.txt") // → "file""#),
            rust_fn: "std_path::nat_basename",
        });
        self.docs.push(StdDoc {
            module: "path",
            name: "aura.lang.std.Path.extname",
            summary: "返回文件扩展名（含点）。",
            params: &[("path", "String", "文件路径")],
            returns: "String",
            returns_desc: "扩展名",
            example: Some(r#"aura.lang.std.Path.extname("file.txt") // → ".txt""#),
        ...
        self.docs.push(StdDoc {
            module: "iter",
            name: "aura.lang.std.Iter.sum",
            summary: "返回列表中所有元素的和。",
            params: &[("list", "List", "源列表")],
            returns: "Int / Float",
            returns_desc: "元素总和",
            example: Some(r#"aura.lang.std.Iter.sum(listOf(1, 2, 3)) // → 6"#),
            rust_fn: "std_iter::nat_sum",
        });
        self.docs.push(StdDoc {
            module: "iter",
            name: "aura.lang.std.Iter.avg",
        ...
        self.docs.push(StdDoc {
            module: "iter",
            name: "aura.lang.std.Iter.distinct",
        ...
        self.docs.push(StdDoc {
            ...
            returns: "List",
            returns_desc: "整数列表",
            example: Some(r#"aura.lang.std.Iter.range(1, 5) // → [1, 2, 3, 4, 5]"#),
        ...
        self.docs.push(StdDoc {
            module: "console",
            name: "aura.lang.std.Console.red",
            summary: "将文本包装为红色 ANSI 颜色代码。",
            params: &[("text", "String", "文本")],
            returns: "String",
            returns_desc: "带颜色代码的字符串",
            example: Some(r#"aura.lang.std.IO.println(console.red("Error!"))"#),
            rust_fn: "std_console::nat_red",
        });
        self.docs.push(StdDoc {
            module: "console",
            name: "aura.lang.std.Console.green",
        ...
        self.docs.push(StdDoc {
            module: "process",
            name: "aura.lang.std.Process.pid",
            summary: "返回当前进程 ID。",
            params: &[],
            returns: "Int",
            returns_desc: "进程 ID",
        ...
        self.docs.push(StdDoc {
            module: "process",
            name: "aura.lang.std.Process.args",
            summary: "返回命令行参数列表。",
            params: &[],
            returns: "List<String>",
            returns_desc: "参数列表",
        ...
        self.docs.push(StdDoc {
            module: "net",
            name: "aura.lang.std.Network.getHostname",
            summary: "返回本机主机名。",
            params: &[],
            returns: "String",
            returns_desc: "主机名字符串",
        ...
        self.docs.push(StdDoc {
            module: "net",
            name: "aura.lang.std.Network.getLocalIp",
            summary: "返回本机 IP 地址。",
            params: &[],
            returns: "String",
        ...
        self.docs.push(StdDoc {
            module: "assert",
            name: "aura.lang.std.Assert.assert",
...
mod tests {
    ...
    fn test_markdown_render() {
        ...
        assert!(md.contains("aura.lang.std.Math.abs"));
    ...
    fn test_html_render() {
        ...
        assert!(html.contains("aura.lang.std.Math.abs"));
    }
