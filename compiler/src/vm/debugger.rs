...
pub fn format_instr(instr: &crate::vm::Instr) -> String {
    ...
    match instr {
        ...
        PushHandler(ip, slot, catch_type) => format!(
            "PushHandler({}, slot={}, catch_type={})",
            ip, slot, catch_type
        ),
        PopHandler => "PopHandler".into(),

        // ── Phase B: 并发运行时指令 ──
        ThreadSpawn(i) => format!("ThreadSpawn({})", i),
        ThreadJoin => "ThreadJoin".into(),
        ThreadSleep => "ThreadSleep".into(),
        ThreadId => "ThreadId".into(),
        ThreadParallelism => "ThreadParallelism".into(),
        MutexNew => "MutexNew".into(),
        MutexLock => "MutexLock".into(),
        MutexUnlock => "MutexUnlock".into(),
        MutexTryLock => "MutexTryLock".into(),
        AtomicNew => "AtomicNew".into(),
        AtomicLoad => "AtomicLoad".into(),
        AtomicStore => "AtomicStore".into(),
        AtomicAdd => "AtomicAdd".into(),
        AtomicCas => "AtomicCas".into(),
        RwLockNew => "RwLockNew".into(),
        RwLockReadLock => "RwLockReadLock".into(),
        RwLockWriteLock => "RwLockWriteLock".into(),
        RwLockReadUnlock => "RwLockReadUnlock".into(),
        RwLockWriteUnlock => "RwLockWriteUnlock".into(),
        ChannelNew => "ChannelNew".into(),
        ChannelSend => "ChannelSend".into(),
        ChannelRecv => "ChannelRecv".into(),
        CondvarNew => "CondvarNew".into(),
        CondvarWait => "CondvarWait".into(),
        CondvarSignal => "CondvarSignal".into(),
        CondvarBroadcast => "CondvarBroadcast".into(),
    }
}
