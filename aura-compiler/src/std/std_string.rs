...
pub fn register(reg: &mut NativeRegistry) {
    reg.register("string.contains", nat_contains);
    reg.register("string.startsWith", nat_starts_with);
    reg.register("string.endsWith", nat_ends_with);
    reg.register("string.split", nat_split);
    reg.register("string.join", nat_join);
    reg.register("string.replace", nat_replace);
    reg.register("string.replaceAll", nat_replace_all);
    reg.register("string.trim", nat_trim);
    reg.register("string.trimStart", nat_trim_start);
    reg.register("string.trimEnd", nat_trim_end);
    reg.register("string.substring", nat_substring);
    reg.register("string.substringBefore", nat_substring_before);
    reg.register("string.substringAfter", nat_substring_after);
    reg.register("string.toLowerCase", nat_to_lower);
    reg.register("string.toUpperCase", nat_to_upper);
    reg.register("string.length", nat_length);
    reg.register("string.isEmpty", nat_is_empty);
    reg.register("string.format", nat_format);
    reg.register("string.repeat", nat_repeat);
    reg.register("string.indexOf", nat_index_of);
    reg.register("string.lastIndexOf", nat_last_index_of);
    reg.register("string.padStart", nat_pad_start);
    reg.register("string.padEnd", nat_pad_end);
    reg.register("string.escape", nat_escape);
    reg.register("string.unescape", nat_unescape);
    reg.register("string.splitLines", nat_split_lines);
    reg.register("string.joinLines", nat_join_lines);
    reg.register("string.countChar", nat_count_char);
    reg.register("string.first", nat_first);
    reg.register("string.last", nat_last);
    reg.register("string.isBlank", nat_is_blank);
    reg.register("string.matches", nat_matches);
    reg.register("string.containsAny", nat_contains_any);
    reg.register("string.containsAll", nat_contains_all);
}
