...
export function assertPluginContext(
  ctx: unknown,
  who = '@aura-lang/dsh-highlight-hat',
): void {
 ...
 */
export const PLUGIN_ID = '@aura-lang/dsh-highlight-hat';
...
export const PREVIEW_ID = '@aura-lang/dsh-highlight-hat/code';
