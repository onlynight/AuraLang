import { getHighlighter, createIncrementalState, tokenizeNextChunk, tokenizeAura, THEME_BY_MODE } from '../lib/highlight.js';

// Typical Aura line (~35 chars) so that the first 32 KB chunk lands near the
