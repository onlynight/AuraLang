/**
 * Degraded tokenizer: colors Aura source without Shiki at all.
 *
...
type Mode = 'code' | 'line-comment' | 'block-comment' | 'string';
...
/**
 * Tokenize Aura source without Shiki.
 *
