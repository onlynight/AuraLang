...
export function assertPluginContext(
  ctx: unknown,
  who = '@phir-lang/dsh-highlight-phir',
): void {
 ...
 */
export const PLUGIN_ID = '@phir-lang/dsh-highlight-phir';
...
export const PREVIEW_ID = '@phir-lang/dsh-highlight-phir/code';
