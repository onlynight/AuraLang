/**
 * Viewport CSS for the PHIR code viewer.
 *
 * Two concerns, one stylesheet:
 *
 *   1. `--PHIR-*` color variables, in the light values on `:root` and the dark
 ...
 *      the tokenizer.
 *
 *   2. The viewer's own layout, scoped under `[data-phir-code]` so it cannot
...
/** Component CSS, scoped under `[data-phir-code]`. */
...
[data-phir-code]{
  ...
  font-size:13px;
  line-height:20px;
  color:var(--PHIR-foreground);
}
[data-phir-code] [data-phir-banner]{
  flex:none;
  display:flex;
  align-items:center;
  gap:8px;
...
[data-phir-code] [data-phir-lang]{
  font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;
  letter-spacing:0.02em;
}
[data-phir-code] [data-phir-status]{
  margin-left:auto;
  color:var(--dsw-alias-label-tertiary,inherit);
}
[data-phir-code] [data-phir-copy]{
  margin-left:auto;
  display:inline-flex;
  align-items:center;
  gap:5px;
...
[data-phir-code] [data-phir-text]{
  padding-right:16px;
  white-space:pre;
  overflow-wrap:normal;
  word-break:normal;
}
[data-phir-code][data-wrap="true"] [data-phir-text]{
  white-space:pre-wrap;
  overflow-wrap:anywhere;
  word-break:break-word;
}
[data-phir-code] [data-phir-empty]{
  padding:16px;
  color:var(--dsw-alias-label-tertiary,inherit);
  font-family:var(--dsw-font-family,sans-serif);
  font-size:13px;
...
export const PLUGIN_CSS: ReadonlyArray<readonly [string, string]> = [
  ['PHIR-theme-variables.css', themeVariableCss()],
  ['PHIR-code-viewer.css', VIEWER_CSS],
];
